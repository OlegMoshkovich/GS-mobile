...
class CommunityScreen extends React.Component {
 constructor(props) {
  ...
  renderNavMenu() {
    ...
    /* not going to clean this up here, because we will refactor the nav menu into its own component

    needs to receive state (this.state.activated) from parent component
