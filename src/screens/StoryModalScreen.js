	...
	renderStoryPng(id) {
		...
		switch (id) {
			...
			case 4:
				...
				break;
			case 5:
				return (<Image style={{width: width, height: 1601, marginBottom: 100, top: -99}} source={require('../../assets/staticScreens/stories/cookieDive2x.png')} />);
				break;
			case 6:
				return (<Image style={{width: width, height: 3583, marginBottom: 100, top: -87}} source={require('../../assets/staticScreens/stories/malala2x.png')} />);
				break;
			case 7:
