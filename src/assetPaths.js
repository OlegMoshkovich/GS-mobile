...
paths.bottomMenu = {
    ...
    avaFace:        require('../assets/bottomMenu/ava/Nav_Avatar_Face_Animations.png'),

    exploreIcon:    require('../assets/bottomMenu/icons/Explore-icon.png'),
    mapIcon:        require('../assets/bottomMenu/icons/Map-icon.png'),
    communityIcon:  require('../assets/bottomMenu/icons/Community-icon.png'),
